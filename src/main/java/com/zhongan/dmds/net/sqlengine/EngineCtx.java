...
public class EngineCtx {
  ...
  public void executeNativeSQLSequnceJob(String[] dataNodes, String sql, SQLJobHandler jobHandler) {
  ...
  public void setAllJobFinishedListener(AllJobFinishedListener allJobFinishedListener) {
  ...
  public void onJobFinished(SQLJob sqlJob) {
    ...
    if (allFinished && finished.compareAndSet(false, true)) {
      LOGGER.info("all job finished  for front connection: " + session.getSource());
