 ...
 * <algorithm>sharding-by-hotdate</algorithm> </rule> </tableRule>
 ...
 * <property name="sPartionDay">30</property> </function>
 */
public class PartitionByHotDate extends AbstractPartitionAlgorithm implements RuleAlgorithm {
  ...
  public Integer calculate(String columnValue) {
    ...
    try {
      ...
      LOGGER
          .debug("PartitionByHotDate calculate for " + columnValue + " return " + targetPartition);
  ...
  public Integer[] calculateRange(String beginValue, String endValue) {
    ...
    try {
      ...
      throw new IllegalArgumentException(new StringBuilder().append("endValue:").append(endValue)
          .append(" Please check if the format satisfied.").toString(), e);
    }
    return targetPartition;
  }
