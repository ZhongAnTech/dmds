...
public class UserSqlHigh {
   ...
   * 排序
   */
  private List<Map.Entry<String, SqlFrequency>> sortFrequency(
      ConcurrentHashMap<String, SqlFrequency> map,
      final boolean bAsc) {
    List<Map.Entry<String, SqlFrequency>> list = new ArrayList<Map.Entry<String, SqlFrequency>>(
        map.entrySet());
