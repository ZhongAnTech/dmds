...
public class SplitUtil {
  ...
  /**
   * 解析字符串<br> 比如:c1='$',c2='-' 输入字符串：mysql_db$0-2<br> 输出array:mysql_db[0],mysql_db[1],mysql_db[2]
   */
  ...
  /**
   * 解析字符串，比如: <br> 1. c1='$',c2='-',c3='[',c4=']' 输入字符串：mysql_db$0-2<br>
   * 输出mysql_db[0],mysql_db[1],mysql_db[2]<br> 2. c1='$',c2='-',c3='#',c4='0' 输入字符串：mysql_db$0-2<br>
   * 输出mysql_db#0,mysql_db#1,mysql_db#2<br> 3. c1='$',c2='-',c3='0',c4='0' 输入字符串：mysql_db$0-2<br>
