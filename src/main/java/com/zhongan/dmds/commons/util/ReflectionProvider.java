...
import com.zhongan.dmds.commons.config.FieldDictionary;
import com.zhongan.dmds.commons.config.Visitor;
...
public class ReflectionProvider {
    ...
    try {
      ...
      if (Serializable.class.isAssignableFrom(type)) {
        ...
        throw new ObjectAccessException(
            "Cannot construct " + type.getName() + " as it does not have a no-args constructor");
      }
  ...
  public void invokeMethod(Object object, String methodName, Object value, Class<?> definedIn) {
    try {
      ...
      throw new ObjectAccessException("Could not invoke " + object.getClass() + "." + methodName,
          e);
    }
  }
  ...
  private Object instantiateUsingSerialization(Class<?> type) {
    try {
      ...
      throw new ObjectAccessException("Cannot create " + type.getName() + " by JDK serialization",
          e);
  ...
  private void validateFieldAccess(Field field) {
    if (Modifier.isFinal(field.getModifiers())) {
      if (com.zhongan.dmds.commons.config.JVMInfo.is15()) {
