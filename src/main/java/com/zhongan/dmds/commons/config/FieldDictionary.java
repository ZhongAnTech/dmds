...
import com.zhongan.dmds.commons.util.ObjectAccessException;
...
public class FieldDictionary {
   ...
   * field name in the specified class cls which should be defined in class definedIn (either equals
   * cls or a one of it's superclasses)
   *
        ...
        if (!nameCache.containsKey(clsName)) { // double check
          ...
          while (!Object.class.equals(cls)) {
            ...
            for (int i = 0; i < fields.length; i++) {
              ...
              keyedByFieldKey
                  .put(new FieldKey(field.getName(), field.getDeclaringClass(), i), field);
            }
