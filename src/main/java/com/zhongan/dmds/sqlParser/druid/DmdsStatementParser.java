...
/**
 * Base on MycatStatementParser
 */
public class DmdsStatementParser extends MySqlStatementParser {
  ...
  public DmdsStatementParser(String sql) {
    super(sql);
    selectExprParser = new DmdsExprParser(sql);
  }

  public DmdsStatementParser(Lexer lexer) {
    super(lexer);
    selectExprParser = new DmdsExprParser(lexer);
  }
  ...
  public SQLSelectStatement parseSelect() {
    ...
    DmdsSelectParser selectParser = new DmdsSelectParser(this.selectExprParser);
  ...
  // {
  // return new DmdsSelectParser(this.selectExprParser);
  // }
