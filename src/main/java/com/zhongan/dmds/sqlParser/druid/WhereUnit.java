 ...
 * Where条件单元
 * <p>
 * 示例： SELECT id,traveldate FROM   travelrecord WHERE  id = 1 AND ( fee > 0 OR days > 0 OR (
 * traveldate > '2015-05-04 00:00:07.375' AND ( user_id <= 2 OR fee = days OR fee > 0 ) ) ) AND name
 * = 'zhangsan' ORDER  BY traveldate DESC LIMIT  20
 */
