    ...
    if (stmt.length() > offset + "M".length()) {
      ...
      if (c1 == 'M' || c1 == 'm') {
        if (stmt.length() > ++offset && stmt.charAt(offset) == '.') {
          ...
          /**
           * 兼容之前指令 在保留 SHOW @@SQL.SUM 指令的同时， 扩展支持 SHOW @@SQL.SUM.TABLE 、
           * SHOW @@SQL.SUM.USER
           */
          if (stmt.length() > (offset + 4)) {
            ...
            } else if ((c2 == 'T' || c2 == 't') && (c3 == 'A' || c3 == 'a') && (c4 == 'B'
                || c4 == 'b')
                && (c5 == 'L' || c5 == 'l')) {
  ...
  static boolean isWhere(String stmt, int offset) {
    if (stmt.length() > offset + 5) {
      ...
      if ((c1 == 'H' || c1 == 'h') && (c2 == 'E' || c2 == 'e') && (c3 == 'R' || c3 == 'r')
        ...
        if ((stmt.length() > offset) && (stmt.charAt(offset) == 'D'
            || stmt.charAt(offset) == 'd')) {
          boolean jump2 = false;
