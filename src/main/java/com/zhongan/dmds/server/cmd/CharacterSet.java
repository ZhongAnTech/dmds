...
public class CharacterSet {
  ...
  public static void response(String stmt, IServerConnection c, int rs) {
    if (-1 == stmt.indexOf(',')) {
      /* 单个属性 */
  ...
  private static void oneSetResponse(String stmt, IServerConnection c, int rs) {
  ...
  private static void multiSetResponse(String stmt, IServerConnection c, int rs) {
  ...
  private static void setCharset(String charset, IServerConnection c) {
